...
const ReadNewsDetail: React.FC = (props) => {
    ...
    const [blogData, setNewsData] = useState<any>({}); // กำหนดประเภทของข้อมูลบทความข่าว
    ...
    return (
        <RootLayout loggedInUser="">
            <div className="container   mx-auto ">
                <div className="my-20">
                    {/* <img className="w-full h-[300px] md:h-[400px] object-cover" src={`https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/${blogData.img}/public`} alt={blogData.img} width={100} height={100} /> */}
                    {/* Content Detail  */}
                        ...
                        <div className="col-span-7 bg-[#ffffff] text-white mt-10 rounded-xl shadow-2xl overflow-hidden">
                            <div className="shadow-black">
                                <img
                                    ...
                                    src={`https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/${blogData.img}/public`}
                                    alt={blogData.img}
                                />
                                <div className="w-full text-end mt-2">
                                    <span className="text-sky-600">{blogData.date}</span>
                                    <span className="text-black"> I </span>
                                    <span className="text-cyan-600 font-black">{blogData.author}</span>
                                </div>
                                <h1 className="text-2xl p-3 text-black">{blogData.subtitle}</h1>
