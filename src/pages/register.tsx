...
const Register: React.FC = (props) => {
    ...
    return (
        <RootLayout loggedInUser="">
            ...
            <div className='register-page my-8'>
                <div className="font-fontTH01 bg-gradient-to-br max-w-2xl mx-auto bg-white/70  w-[300px] sm:w-12 md:w-6/12 lg:w-6/12 2xl:w-5/12  px-6 py-10 sm:px-10 sm:py-6  rounded-lg shadow-md lg:shadow-lg ">
                    <h2 className="text-lg text-1xl lg:text-3xl text-black ">
                        สมัครสมาชิก
                    </h2>
                    <form className="mt-10 " method="POST" onSubmit={handleSubmit}>
                        <div className=" top-[100px] flex gap-6 mb-6 lg:grid-cols-2">
                            <div className='w-[50%]'>
                                <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-black dark:text-gray-300">ชื่อ</label>
                                <input type="text"
                                    value={fname}
                                    onChange={(e) => setFname(e.target.value)} id="first_name" className="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="กรูณากรอกชื่อ" pattern="^[A-Za-zก-๙\s]*$" title="กรุณากรอกข้อมูลให้ถูกต้อง" required />
                            </div>
                            <div className='w-[50%]'>
                                <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-black dark:text-gray-300">นามสกุล</label>
                                <input type="text"
                                    value={lname}
                                    onChange={(e) => setLname(e.target.value)} id="last_name" className="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="กรูณากรอกนามสกุล" pattern="^[A-Za-zก-๙\s]*$" title="กรุณากรอกข้อมูลให้ถูกต้อง" required />
                            </div>

                        </div>
                        <div className="mb-6 my-5">
                            <label htmlFor="phone" className="block mb-2 text-sm font-medium text-black dark:text-gray-300">เบอร์โทรศัพท์</label>
                            <input type="number"
                                value={tel}
                        ...
                        <div>
                            <label htmlFor="date" className="block mb-2 text-sm font-medium text-black dark:text-gray-300">วัน/เดือน/ปี เกิด</label>
                            <input type="date"
                                value={birthday}
                        ...
                        <div>
                            ...
                            <div className="mb-6">
                                <label htmlFor="confirm_password" className="block mb-2 text-sm font-medium text-black dark:text-gray-300">Confirm password</label>
                                <input
                                    type={showPassword ? 'text' : 'password'} // ใช้ showPassword เพื่อเปิดหรือปิดการแสดงรหัสผ่าน
                                    ...
                                    required
                                />
                                {!passwordsMatch && <p className="text-black">กรุณากรอกรหัสผ่านให้ถูกต้อง</p>}
                            </div>
                    ...
                    {secretKey && (
                        <div className="mb-4">
                            <p className="text-black">Your secret key: {secretKey}</p>
                            <p className="text-black">Please save this key securely.</p>
                        </div>
                    )}
                    ...
                    <div className="sm:flex sm:flex-wrap mt-8 sm:mb-4 text-sm text-center justify-center text-black">
